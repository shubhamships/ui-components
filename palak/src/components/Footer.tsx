  ...
  return (
    <div className="bg-footer w-full h-96">
      <div className="flex items-center flex-col md:flex-row md:justify-center gap-5">
        <p className="text-purple-200 text-xs mt-20 md:mt-24">LINKEDIN</p>
        <p className="text-purple-200 text-xs md:mt-24">EMAIL</p>
        <p className="text-purple-200 text-xs md:mt-24">INSTAGRAM</p>
      </div>
