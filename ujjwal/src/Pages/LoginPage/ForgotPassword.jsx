            ...
            <div className='flex items-center justify-center text-sm'>
                <div className='rounded-lg max-w-md w-full'>
                    ...
                    <form onSubmit={handleSubmit} className='pl-6 pr-6 mb-36'>
                        <p className='text-center'>Enter email address associated with your account and you will receive an email to reset your password.</p>
                        <div className='space-y-1 mt-5'>
                            <InputField isRequired type="email" placeholder='Enter Email ID . . .' className='h-10 w-full px-3 py-2 border border-gray-300 rounded-md' label={"Email"}/>
                        </div>
